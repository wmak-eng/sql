...
SELECT c.customer_id, c.customer_first_name, c.customer_last_name, x.total_spent
FROM customer c
INNER JOIN (
	SELECT cp.customer_id, sum((quantity * cost_to_customer_per_qty)) AS total_spent
